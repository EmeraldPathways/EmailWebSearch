...
3. Ensure `.gitignore` excludes: `node_modules/`, `dist/`, `.env`, `data/*.db`, `data/snapshots/`, `.claude/`
...
## Repo
`https://github.com/EmeraldPathways/instagramresearcher`

## Notes
- Never commit `.env` or any file containing secrets
- Never commit `data/snapshots.db` or snapshot JSON files
